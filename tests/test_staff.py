...
class FilebrowserStaffTestCase(TestCase):
    ...
    def test_browse(self):
        ...
        with tempfile.NamedTemporaryFile(dir=self.upload_dir,
                                         prefix='fb-',
                                         suffix='-test.txt') as temp_file:
    ...
    def test_mkdir(self):
        url = reverse('fb_mkdir')
        redirect_url = reverse('fb_browse') + get_query_string({'ot': 'desc',
                                                                'o': 'date'})
    ...
    def test_rename(self):
        ...
        response = self.client.post(
            ...
            data={
                'name': os.path.splitext(new_file_name)[0],
            },
            follow=True,
        )
        self.assertEqual(200, response.status_code)
    ...
    def test_do_upload(self):
        ...
        test_file = ContentFile(b'Test File content',
                                name='test-file-upload.txt')
