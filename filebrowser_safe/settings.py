...
DEFAULT_PATH_TINYMCE = os.path.join(
    settings.MEDIA_ROOT, "admin/tinymce/jscripts/tiny_mce/"
)
...
PATH_FILEBROWSER_MEDIA = getattr(
    ...
    os.path.join(settings.MEDIA_ROOT, "filebrowser/"),
)
...
ESCAPED_EXTENSIONS = getattr(
    settings, "FILEBROWSER_ESCAPED_EXTENSIONS", ("html", "svg")
)
